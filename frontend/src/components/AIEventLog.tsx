...
//   // const [events, setEvents] = useState<GraphRebalanceData[]>([]); ---> PRODUCTION MODE
//   // [HACKATHON DEMO MODE]: Injeksi data on-chain buatan agar UI selalu hidup saat presentasi
...
//       // Menggunakan timestamp statis asli dari transaksimu. 100% aman dari linter!
